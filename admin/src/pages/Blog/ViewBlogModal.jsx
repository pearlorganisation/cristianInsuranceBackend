...
export default function ViewBlogModal ({viewData,setModal}) {
  ...
  >
    ...
    >
      ...
      <div id="content-3a" className="flex-1 overflow-auto space-y-10">
        ...
        <div>
        {viewData ? <img src={viewData.banner} alt="Theater Logo" className="rounded-lg sm:h-100 sm:w-230" /> : ''}
        </div>
        <div className='font-bold text-3xl text-black-2'>
